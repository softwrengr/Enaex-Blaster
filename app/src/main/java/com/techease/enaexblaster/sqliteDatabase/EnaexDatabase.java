...
public class EnaexDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String byHoleQuery = "CREATE TABLE BY_HOLE (ID INTEGER PRIMARY KEY AUTOINCREMENT,DIAMETER,DENSITY,BURDEN,SPACING,HOLE_LENGTH," +
                "STEM_LENGTH,ROCK_DENSITY,DISTANCE,SCALING,ATTENUATION,ROW_NAME)";
        ...
        String byShotQuery = "CREATE TABLE BY_SHOT (ID INTEGER PRIMARY KEY AUTOINCREMENT,HOLES,ROWS,DIAMETER,DENSITY,BURDEN,SPACING,BENCH_HEIGHT," +
                "SUB_DRILL,STEM_LENGTH,ROCK_DENSITY,HOLE_MS,DISTANCE,SCALING,ATTENUATION,ROW_NAME)";

        String sclaedDistanceqQuery = "CREATE TABLE SCALED_DISTANCE (ID INTEGER PRIMARY KEY AUTOINCREMENT,DISTANCE,MIC,ROW_NAME)";

        String vibrationQuery = "CREATE TABLE VIBRATION (ID INTEGER PRIMARY KEY AUTOINCREMENT,DISTANCE,MIC,SCALING_FACTOR,ATTENUATION,ROW_NAME)";

        String SDOBQuery = "CREATE TABLE SDOB (ID INTEGER PRIMARY KEY AUTOINCREMENT,DIAMETER,DENSITY,HOLE_LENGHT,STEM_LENGHT,ROW_NAME)";

        String PowderFactorQuery = "CREATE TABLE Powder_Factor (ID INTEGER PRIMARY KEY AUTOINCREMENT,DIAMETER,DENSITY,BURDEN,SPACING," +
                                                                "HOLE_LENGHT,STEM_LENGHT,ROCK_DENSITY,AIR_DECK,ROW_NAME)";

        String ExplosiveWeightQuery = "CREATE TABLE EXPLOSIVE_WEIGHT (ID INTEGER PRIMARY KEY AUTOINCREMENT,DIAMETER,DENSITY,HOLE_LENGHT,STEM_LENGHT,ROW_NAME)";

        String VolumeQuery = "CREATE TABLE VOlUME (ID INTEGER PRIMARY KEY AUTOINCREMENT,BURDEN,SPACING,AVERAGE_DEPTH,HOLES,ROCK_DENSITY,ROW_NAME)";
